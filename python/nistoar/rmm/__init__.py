...
_RMMSYSNAME = "Public Data Repository"
_RMMSYSABBREV = "RMM"
_RMMSUBSYSNAME = _RMMSYSNAME
_RMMSUBSYSABBREV = _RMMSYSABBREV
...
class RMMSystem(SystemInfoMixin):
    ...
    @property
    def system_name(self): return _RMMSYSNAME
    @property
    def system_abbrev(self): return _RMMSYSABBREV
    @property
    def subsystem_name(self): return _RMMSUBSYSNAME
    @property
    def subsystem_abbrev(self): return _RMMSUBSYSABBREV
